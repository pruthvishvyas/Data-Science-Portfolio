...
- ## Business Analytics : End to End MLOps & Analytics Projects
  ...
  - [Global Company Financial Intelligence Pipeline](https://github.com/pruthvishvyas/s1p1): An automated end-to-end pipeline that unifies 5 global financial datasets into a single "Investment Intelligence" framework.
  - [E-Commerce Shipment Delay Prediction](https://github.com/pruthvishvyas/s1p2): 59.7% of 10,999 shipments arrived late across a 2-year e-commerce logistics dataset. The analysis surfaces one structural pattern: discount depth and operational friction before dispatch predict failure more reliably than shipment mode or product weight.
  - [Football Player Performance Analytics](https://github.com/pruthvishvyas/s1p3): Among 1039 players analysed, only 3 (3.7%) qualify as Elite tier, confirming the Pareto principle in football talent. Average performance score across 81 qualified players: 0.142.
